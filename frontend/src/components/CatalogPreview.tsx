    ...
    <div className="w-full space-y-4">
      ...
      <div className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md border border-slate-200/60 dark:border-zinc-800/65 px-3 py-2.5 rounded-2xl shadow-sm flex flex-wrap items-center justify-between gap-3 print:hidden transition-colors">
        ...
        <div className="flex items-center gap-2 shrink-0">
          {/* Segmented Control */}
          <div className="bg-slate-100 dark:bg-zinc-955 p-1 rounded-xl flex items-center gap-1 border border-slate-200/50 dark:border-zinc-900">
            <button
              ...
              className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-all cursor-pointer ${
                viewMode === 'dashboard'
                  ? 'bg-white dark:bg-zinc-800 text-slate-850 dark:text-zinc-100 shadow-sm border border-slate-200/40 dark:border-zinc-700/40'
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 bg-brand-500 hover:bg-brand-600 dark:bg-brand-600 dark:hover:bg-brand-700 text-white text-[10px] font-bold uppercase tracking-wider rounded-xl transition-all cursor-pointer shadow-md shadow-brand-500/15"
          >
