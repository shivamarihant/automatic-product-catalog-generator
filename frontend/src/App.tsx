                    ...
                    >
                      ...
                      <div className="p-5 flex flex-col flex-1">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          {prod.fetchedData?.firstMoverAdvantage && (
                            <span className={`px-2.5 py-1 rounded-lg text-[9px] font-bold uppercase tracking-wider ${
                              prod.fetchedData.firstMoverAdvantage.toUpperCase() === 'YES' || prod.fetchedData.firstMoverAdvantage.toUpperCase() === 'HIGH'
                                ? 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400' 
                                : prod.fetchedData.firstMoverAdvantage.toUpperCase() === 'MEDIUM'
                                ? 'bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400'
                                : 'bg-slate-100 dark:bg-zinc-800 text-slate-600 dark:text-zinc-300'
                            }`}>
                              FMA: {prod.fetchedData.firstMoverAdvantage}
                            </span>
                          )}
                        </div>
                      </div>
